    ...
    <>
      ...
      <main className={setupFormStyles.main_section}>
        ...
        <h2 className={setupFormStyles.subheading}>
          Change your existing sports or levels, or add any new sports that you
          want to try here
        </h2>
        <form action={handleUpdate} className={setupFormStyles.form}>
          ...
          <select name="sport_2" id="sport_2" className={setupFormStyles.input}>
            <option>--Please choose an option--</option>
            {sports.map((sport, i) => {
              return (
                <option key={`sportoption${i}`} value={sport.id}>
          ...
          <select name="level_2" id="level_2" className={setupFormStyles.input}>
            <option>--Please choose an option--</option>
            {levels.map((level, i) => {
              return (
                <option key={`leveloption${i}`} value={level.id}>
          ...
          <select name="sport_3" id="sport_3" className={setupFormStyles.input}>
            <option>--Please choose an option--</option>
            {sports.map((sport, i) => {
              return (
                <option key={`sportoption${i}`} value={sport.id}>
          ...
          <select name="level_3" id="level_3" className={setupFormStyles.input}>
            <option>--Please choose an option--</option>
            {levels.map((level, i) => {
              return (
                <option key={`leveloption${i}`} value={level.id}>
